;;; ../Dot-files-main/doom/+keys.el -*- lexical-binding: t; -*-
...
(require 'gptel)                                        ;List of models
                                        ;
;; OPTIONAL configuration
(setq
 gptel-model "qwen2:0.5b"
...
;; make this a smart button -its the only ones we got
;; (global-set-key (kbd "C-x SPC")
;;                  (lambda ()
;;                    (interactive)
;;                    (find-file "~/Documents/fortress_of_solitude/adnan.org")))
...
;(global-set-key "\C-c\m" 'execute-extended-command)
 ...
 ;; cant read the code on a big system - have to do log experiments - mark of good programmer - figure out how to get it done.
